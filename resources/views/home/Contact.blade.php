      ...
      <section id="hero" class="hero">
        <div class="row d-flex align-items-center">
          <div class="container text-center">
            ...
            ><a data-aos="fade-up"> | Contact Us</a>
          </div>
        </div>
      ...
      <section id="contact" class="contact">
        <div class="container position-relative" data-aos="fade-up">
          <div class="row icon-boxes">
            <div class="col icon-box">
              <div class="icon">
                ...
                <h4 class="title text-center">Alamat</h4>
            ...
            <div class="col icon-box">
              <div class="icon">
                ...
                <h4 class="title text-center">Phones</h4>
                <p class="description text-center">
            ...
            <div class="col icon-box">
              <div class="icon">
                ...
                <h4 class="title text-center">Email</h4>
                <p class="description text-center">
            ...
            <div class="col icon-box">
              <div class="icon">
                ...
                <h4 class="title text-center">Working Hours</h4>
                <p class="description text-center">
                  {{$contact->working}}<br />{{$contact->hours}}
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="icon-box text-center">
            <h4 class="title">Kunjungi Kami</h4>
            <iframe
              src="https://www.google.com/maps/embed?pb={{$contact->maps}}"
              width="1300"
              height="400"
              style="border: 0"
              allowfullscreen=""
