        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="form-group">
                    ...
                    <textarea name="description" id="" cols="30" rows="10" class="form-control" placeholder="Deskripsi">{{$layanan->description}}</textarea>
                </div>
                @error('description')
                <small style="color:red">{{$message}}</small>
                 @enderror

                 <img src="/image/{{$layanan->image}}" alt="" class="img-fluid">
                <div class="form-group">
