    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/dashboard">
                <div class="sidebar-brand-text mx-3">Dashboard SIMS</div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="/pemerintahan">Pemerintah</a>
                        <a class="collapse-item" href="/pendidikan">Pendidikan</a>
                        <a class="collapse-item" href="/isp">ISP</a>
                        <a class="collapse-item" href="/telco">Telco</a>
                        <h6 class="collapse-header">Mitra :</h6>
                        <a class="collapse-item" href="/finance">Finance</a>
